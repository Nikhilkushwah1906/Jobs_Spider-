...
export default function CreateAccountFirst() {
  ...
  var dataTrending = [
    ...
    },
    {
      ...
      color: "#ffeaa7",
      image: "work-from-home-jobs.webp",
    },
    {
      jobtypeid: 2,
      trending: "Trending @ #3",
      jobtype: "Jobs for Women",
      color: "#fd79a8",
      image: "women-jobs.webp",
    },
    {
      jobtypeid: 3,
      trending: "Trending @ #4",
      ...
      color: "#74b9ff",
      image: "part-time-jobs.webp",
    },
    {
      jobtypeid: 4,
      trending: "Trending @ #5",
      jobtype: "International Jobs",
      color: "#2ecc71",
      image: "international-jobs.webp",
    },
  ];
